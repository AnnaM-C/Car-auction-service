...
public class Auctioneer {
	 ...
	 * Parameters, none
	 * @return a formatted String that includes, the ID, name, asking price, type, style, colour, number of seats, and condition of unsold car.
	 */
	...
	/**
	 * Method removes the advert if the car was placed in the soldCars HashMap. The advert cannot be null otherwise an execption
	 *     is thrown.
	 * @param advert
	 */
	public void endSale(Advert advert) {
		...
		if (advert == null) {
			...
			if (soldCars.containsKey(advert)) {
				//Remove the advert so no further purchases can be made.
